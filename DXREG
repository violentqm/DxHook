...
rs2:NewButton("Lay Spinbot (T)", "ButtonInfo", function()
   	local L_383_ = false
...
rs2:NewButton("Spinbot (C)", "ButtonInfo", function()
    	local L_165_ = false
...
mms:NewButton("Headless (CLIENT SIDED)", "ButtonInfo", function()
...
gms:NewKeybind("Toggle UI Keybind", "KeybindInfo", Enum.KeyCode.V, function()
	Library:ToggleUI()
end)
gms:NewButton("Best Animations", "ButtonInfo", function()
...
gms:NewButton("Toggle Speed Glitch (X)", "ButtonInfo", function()
...
gms:NewButton("Fly (X)", "ButtonInfo", function() 
